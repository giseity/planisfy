...
const ORG_PERMISSION_MIN_ROLE = {
  ...
  "operations.jobs.manage": "admin",
  "operations.schedules.manage": "admin",
  "operations.notifications.manage": "admin",
  "operations.backups.manage": "admin",
  "operations.workers.manage": "admin",
  "operations.routing.manage": "admin",
  "operations.delivery.manage": "admin",
  "operations.templates.manage": "admin",
  "platform.readiness.view": "admin",
  "platform.environment.view": "admin",
