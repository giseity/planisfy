...
export function getRuntimeSecret(name: string, options: RuntimeSecretOptions = {}): string {
...
export function redisConnectionFromEnv(env: { REDIS_URL: string }): RedisConnection {
