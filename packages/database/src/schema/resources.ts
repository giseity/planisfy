...
export const styleVersions = pgTable(
  ...
  (table) => [
    ...
    uniqueIndex('style_versions_style_version_unique').on(table.styleId, table.version),
  ]
)
...
export const apiKeys = pgTable(
  ...
  (table) => [
    ...
    uniqueIndex('apikey_reference_creation_request_unique')
      .on(table.referenceId, table.creationRequestId)
