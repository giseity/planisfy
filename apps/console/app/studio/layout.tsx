...
import { Palette, Key, BarChart3, Settings, Database, Building2, LayoutDashboard, ServerCog, SlidersHorizontal } from "lucide-react"
...
const navItems = [
  ...
  { href: "/studio/platform", label: "Platform", icon: SlidersHorizontal },
