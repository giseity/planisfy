...
class ApiClient {
  ...
  getSpriteAssets() {
    return this.get<ApiEnvelope<ConsoleSpriteAsset[]>>('/sprite-assets').then((res) => ({
  ...
  uploadSpriteAsset(options: {
    ...
    return this.formRequest<ApiEnvelope<ConsoleSpriteAsset>>('/sprite-assets', body).then(
      (res) => ({
  ...
  updateSpriteAsset(
    ...
    return this.patch<ApiEnvelope<ConsoleSpriteAsset>>(`/sprite-assets/${id}`, options).then(
      (res) => ({
        data: normalizeSpriteAssetPreviewUrl(res.data),
      })
    )
  ...
  deleteSpriteAsset(id: string) {
    return this.delete<ApiEnvelope<{ id: string; deleted: boolean }>>(`/sprite-assets/${id}`)
  }
  ...
  uploadProfileAvatar(file: File) {
    const body = new FormData()
    body.set('file', file)
    return this.formRequest<ApiEnvelope<ConsoleProfile>>('/profile/avatar', body).then((res) => ({
      data: normalizeProfileAvatarUrl(res.data),
    }))
  }

  deleteProfileAvatar() {
    return this.delete<ApiEnvelope<ConsoleProfile>>('/profile/avatar').then((res) => ({
      data: normalizeProfileAvatarUrl(res.data),
    }))
  }
  ...
  getJobTimeline(jobId: string) {
    return this.get<ApiEnvelope<ConsoleJobTimeline>>(`/operations/jobs/${jobId}/timeline`)
  }
  ...
  createScheduledOperation(options: {
    ...
    return this.post<ApiEnvelope<ConsoleScheduledOperation>>('/operations/schedules', options)
  }
  ...
  deleteScheduledOperation(id: string) {
    return this.delete<ApiEnvelope<{ id: string; deleted: boolean }>>(`/operations/schedules/${id}`)
  }

  createArtifactBackup(storageObjectId: string) {
    return this.post<ApiEnvelope<ConsoleArtifactBackup>>('/operations/artifact-backups', {
      storageObjectId,
    })
  }
  ...
  createWorkerNode(options: {
    ...
    return this.post<ApiEnvelope<ConsoleWorkerNode>>('/operations/worker-nodes', options)
  }

  validateWorkerNode(id: string) {
    return this.post<ApiEnvelope<ConsoleWorkerNode>>(`/operations/worker-nodes/${id}/validate`)
  }
  ...
  listRoutingGraphBuilds() {
    return this.get<ApiEnvelope<ConsoleRoutingGraphBuild[]>>('/operations/routing-graphs')
  }
  ...
  createRoutingGraphBuild(options: {
    ...
    return this.post<ApiEnvelope<ConsoleRoutingGraphBuild>>('/operations/routing-graphs', options)
  }

  getRoutingGraphBuild(id: string) {
    return this.get<ApiEnvelope<ConsoleRoutingGraphBuildDetail>>(`/operations/routing-graphs/${id}`)
  }
  ...
  listBasemapBuilds() {
    return this.get<ApiEnvelope<ConsoleBasemapBuild[]>>('/operations/basemap-builds')
  }
  ...
  createBasemapBuild(options: {
    ...
    return this.post<ApiEnvelope<ConsoleBasemapBuild>>('/operations/basemap-builds', options)
  }

  getBasemapBuild(id: string) {
    return this.get<ApiEnvelope<ConsoleBasemapBuildDetail>>(`/operations/basemap-builds/${id}`)
  }

  cancelBasemapBuild(id: string) {
    return this.post<ApiEnvelope<ConsoleBasemapBuild>>(`/operations/basemap-builds/${id}/cancel`)
  }
  ...
  createPreviewLink(options: {
    ...
    return this.post<ApiEnvelope<ConsolePreviewLink>>('/operations/preview-links', options)
  }
  ...
  createCustomDomain(options: {
    ...
    return this.post<ApiEnvelope<ConsoleCustomDomain>>('/operations/custom-domains', options)
  }

  verifyCustomDomain(id: string) {
    return this.post<ApiEnvelope<ConsoleCustomDomain>>(`/operations/custom-domains/${id}/verify`)
  }
  ...
  cancelJob(jobId: string) {
    return this.post<ApiEnvelope<ConsoleProcessingJob>>(`/jobs/${jobId}/cancel`)
  }

  rebuildTileset(tilesetId: string) {
    return this.post<ApiEnvelope<ConsoleProcessingJob>>(`/tilesets/${tilesetId}/rebuild`)
  }

  createTileset(options: CreateTilesetOptions) {
    return this.post<ApiEnvelope<ConsoleTileset>>('/tilesets', options).then((res) => ({
      data: normalizeTilesetUrls(res.data),
    }))
  }

  deleteTileset(tilesetId: string) {
    return this.delete<ApiEnvelope<{ id: string; deleted: boolean }>>(`/tilesets/${tilesetId}`)
  }
  ...
  uploadTileset(tilesetId: string, file: File, options: TilesetUploadOptions) {
    ...
    return this.upload<ApiEnvelope<TilesetUploadResult>>(`/tilesets/${tilesetId}/uploads`, formData)
  }
