...
var page_1 = require("fumadocs-ui/layouts/docs/page");
var navigation_1 = require("next/navigation");
var mdx_components_1 = require("@/mdx-components");
var mdx_1 = require("fumadocs-ui/mdx");
var page_actions_1 = require("@/components/ai/page-actions");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    MDX = page.data.body;
                    return [2 /*return*/, (<page_1.DocsPage toc={page.data.toc} full={page.data.full}>
      <page_1.DocsTitle>{page.data.title}</page_1.DocsTitle>
      <page_1.DocsDescription className="mb-0">{page.data.description}</page_1.DocsDescription>
      <div className="flex flex-row gap-2 items-center border-b pb-6">
        <page_actions_1.LLMCopyButton markdownUrl={"".concat(page.url, ".mdx")}/>
        <page_actions_1.ViewOptions markdownUrl={"".concat(page.url, ".mdx")} 
                        // update it to match your repo
                        githubUrl={"https://github.com/".concat(layout_shared_1.gitConfig.user, "/").concat(layout_shared_1.gitConfig.repo, "/blob/").concat(layout_shared_1.gitConfig.branch, "/content/docs/").concat(page.path)}/>
      </div>
      <page_1.DocsBody>
