...
Use `DEPLOYMENT_MODE=self_host` for Docker Compose, VPS platforms, and other environments where you operate the runtime services. Self-host mode disables hosted checkout and billing portal actions. It also bypasses managed subscription feature gates; usage and limits remain visible for operational awareness.
