...
ROOT_AGENT_CAPABILITIES=valhalla_graph_build,basemap_build,dem_hydration,self_host_activation
...
Small installs can use one root agent for both roles. Larger installs often use separate build and serving machines.
