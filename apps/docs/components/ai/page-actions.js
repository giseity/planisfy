...
exports.ViewOptions = exports.LLMCopyButton = void 0;
var react_1 = require("react");
var lucide_react_1 = require("lucide-react");
var cn_1 = require("@/lib/cn");
var use_copy_button_1 = require("fumadocs-ui/utils/use-copy-button");
var button_1 = require("fumadocs-ui/components/ui/button");
var popover_1 = require("fumadocs-ui/components/ui/popover");
var cache = new Map();
function LLMCopyButton(_a) {
    var _this = this;
    var 
    /**
     * A URL to fetch the raw Markdown/MDX content of page
     */
    markdownUrl = _a.markdownUrl;
    var _b = (0, react_1.useState)(false), isLoading = _b[0], setLoading = _b[1];
    var _c = (0, use_copy_button_1.useCopyButton)(function () { return __awaiter(_this, void 0, void 0, function () {
        var cached;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    cached = cache.get(markdownUrl);
                    if (cached)
                        return [2 /*return*/, navigator.clipboard.writeText(cached)];
                    setLoading(true);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, , 3, 4]);
                    return [4 /*yield*/, navigator.clipboard.write([
                            new ClipboardItem({
                                'text/plain': fetch(markdownUrl).then(function (res) { return __awaiter(_this, void 0, void 0, function () {
                                    var content;
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
    ...
    }); }), checked = _c[0], onClick = _c[1];
    return (<button disabled={isLoading} className={(0, cn_1.cn)((0, button_1.buttonVariants)({
            color: 'secondary',
            size: 'sm',
...
exports.LLMCopyButton = LLMCopyButton;
function ViewOptions(_a) {
    var markdownUrl = _a.markdownUrl, githubUrl = _a.githubUrl;
    var items = (0, react_1.useMemo)(function () {
        var fullMarkdownUrl = typeof window !== 'undefined' ? new URL(markdownUrl, window.location.origin) : 'loading';
        var q = "Read ".concat(fullMarkdownUrl, ", I want to ask questions about it.");
        return [
            {
            ...
            },
            {
                ...
                icon: (<svg role="img" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <title>OpenAI</title>
            ...
            <path d="M11.503.131 1.891 5.678a.84.84 0 0 0-.42.726v11.188c0 .3.162.575.42.724l9.609 5.55a1 1 0 0 0 .998 0l9.61-5.55a.84.84 0 0 0 .42-.724V6.404a.84.84 0 0 0-.42-.726L12.497.131a1.01 1.01 0 0 0-.996 0M2.657 6.338h18.55c.263 0 .43.287.297.515L12.23 22.918c-.062.107-.229.064-.229-.06V12.335a.59.59 0 0 0-.295-.51l-9.11-5.257c-.109-.063-.064-.23.061-.23"/>
                ...
                href: "https://cursor.com/link/prompt?".concat(new URLSearchParams({
                    text: q,
                })),
            },
        ];
    ...
    return (<popover_1.Popover>
      <popover_1.PopoverTrigger className={(0, cn_1.cn)((0, button_1.buttonVariants)({
            color: 'secondary',
            size: 'sm',
            className: 'gap-2',
        }))}>
        Open
        <lucide_react_1.ChevronDown className="size-3.5 text-fd-muted-foreground"/>
      </popover_1.PopoverTrigger>
      <popover_1.PopoverContent className="flex flex-col">
        {items.map(function (item) { return (<a key={item.href} href={item.href} rel="noreferrer noopener" target="_blank" className="text-sm p-2 rounded-lg inline-flex items-center gap-2 hover:text-fd-accent-foreground hover:bg-fd-accent [&_svg]:size-4">
            {item.icon}
            {item.title}
            <lucide_react_1.ExternalLinkIcon className="text-fd-muted-foreground size-3.5 ms-auto"/>
          </a>); })}
