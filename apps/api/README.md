...
Important config: `DATABASE_URL`, `REDIS_URL`, `BETTER_AUTH_SECRET`, `INTERNAL_API_SECRET`, `MARTIN_URL`, `VALHALLA_URL`, `PELIAS_URL`, `GLYPHS_URL`, `ELEVATION_URL`, `STATIC_MAP_URL`, storage provider variables, Dodo, and Resend.
