...
import { env } from '../../env'
import { isCheckoutConfiguredForPlan, listPlanDefinitions } from '../billing/billing'
...
internalSmokeRoute.get('/internal/managed-smoke', async (c) => {
  ...
  const email = {
    ...
    fromAuth: env.ZEPTOMAIL_FROM_AUTH,
    fromNotifications: env.ZEPTOMAIL_FROM_NOTIFICATIONS,
  }
