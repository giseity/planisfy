...
set_env_if_blank_or_default S3_ENDPOINT "http://localhost:9000" ""
set_env_if_blank_or_default CONTAINER_S3_ENDPOINT "http://minio:9000" ""
set_env_if_blank_or_default S3_PUBLIC_URL "http://localhost:9000/planisfy-artifacts" ""
set_env_if_blank_or_default AWS_ACCESS_KEY_ID "planisfy" ""
set_env_if_blank_or_default AWS_SECRET_ACCESS_KEY "planisfy-local-minio-password" ""
set_env_if_blank_or_default MINIO_ROOT_USER "planisfy" ""
set_env_if_blank_or_default MINIO_ROOT_PASSWORD "planisfy-local-minio-password" ""
